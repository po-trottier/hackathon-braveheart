...
function getUrl(message, callback) {
    ...
    const happy =  message.includes('friend') || message.includes('like') || message.includes('amazing') || message.includes('gr8') || message.includes('superb') || message.includes('gay') ||message.includes('excited') || message.includes('new') || message.includes('thrilled') || message.includes('cheerful') || message.includes('happy') || message.includes('good') || message.includes('joyful') || message.includes('smiley') || message.includes('great');
    const sad = message.includes('dead') || message.includes('die') ||  message.includes('hit me') || message.includes('kill myself') || message.includes('shit') || message.includes('accident') || message.includes('died') || message.includes('hurt') || message.includes('cry') || message.includes('heartbroken') || message.includes('sad') || message.includes('depressed') || message.includes('bad') ;
    const mad = message.includes('that bitch') || message.includes('punch') || message.includes('screw you') ||message.includes('fuck you') || message.includes('kill') || message.includes('fired') || message.includes('pissed') || message.includes('cheated') || message.includes('rage') || message.includes('angry') || message.includes('mad');
    ...
    const party = message.includes('move') || message.includes('dance') || message.includes('turn') || message.includes('newyears') || message.includes('new year') || message.includes('predrink') || message.includes('club') || message.includes('friends') || message.includes('turnup') || message.includes('turn up') || message.includes('party');
    const motivation = message.includes('motiva') || message.includes('hate') ||  message.includes('difficult') || message.includes('hard') || message.includes('hackathon') || message.includes('conuhacks') || message.includes('challenge') || message.includes('working out') || message.includes('work out') || message.includes('gym') || message.includes('motivation');
    const sleep = message.includes('don\'t want to sleep') || message.includes('dont want to sleep') || message.includes('hate') || message.includes('rest') || message.includes('bed') || message.includes('l8') || message.includes('late') || message.includes('nite') || message.includes('night') || message.includes('early') || message.includes('exhausted') || message.includes('tired') || message.includes('sleep');
    const study = message.includes('concentrate') || message.includes('chapters') ||message.includes('material') ||message.includes('read') || message.includes('writ') ||message.includes('prog') ||message.includes('coding') ||message.includes('code') ||message.includes('study') ;
    const mood_booster =  message.includes('boost') || message.includes('kill me') ||  message.includes('overwhelmed') || message.includes('burn') ||message.includes('hate') || message.includes('mood_booster') || message.includes('day to be over') || message.includes('day to die');
